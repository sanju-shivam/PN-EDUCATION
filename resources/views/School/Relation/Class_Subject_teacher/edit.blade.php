        ...
        @endif
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('class/teacher/subject/update/'.$relation->id) }}">
                        @csrf
                        <div class="row">
                        	...
                        	<div class="col-md-4 col-sm-4 col-xs-4">
		                        <div class="form-group">
		                            <label >Teacher</label>
		                            <select disabled name="" required class="form-control custom-select">
		                                <option value="">Select</option>
		                        ...
		                        <div class="form-group">
		                            ...
		                            <select name="subject_id" required class="form-control custom-select">
		                                ...
		                                @foreach($subjects as $subject)
		                                    <option @if($relation->subject_id == $subject->id) selected @endif value="{{ $subject->id }}">{{ $subject->name }}</option>
		                                @endforeach
		                            </select>
		                        </div>	
                        	</div>
