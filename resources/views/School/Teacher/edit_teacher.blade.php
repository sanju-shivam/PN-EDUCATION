                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('teacher.update',$teacher->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="name" value="{{ $teacher->name }}" class="form-control" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" required  name="phone_no" value="{{ $teacher->phone_no }}" class="form-control" placeholder="Enter Phone Number" >
                        </div>
                        <div class="form-group">
                            <label >Email
                                <sub style="color: red;font-size: 20px;">*</sub>
                            </label>
                            <input type="email" required name="email" value="{{ $teacher->email }}" class="form-control" placeholder="Enter Email">
                        </div>
                        <div class="form-group">
                            <label >Password
                                <sub style="color: red;font-size: 20px;">*</sub>
                            </label>
                            <input type="password" required name="password" value="{{ $teacher->password }}" class="form-control" placeholder="Enter Password">
                        </div>
                        <div class="form-group">
                            <label >Aadhar Number</label>
                            <input type="alpha_num" name="id_proof" value="{{ $teacher->id_proof }}" class="form-control" placeholder="Enter Affilation Number">
                        </div>
