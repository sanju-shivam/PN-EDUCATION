                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone_number" class="form-control" placeholder="Enter PIN-CODE">
                        </div>
                        <div class="form-group">
                            <label >Email</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="affilation_number" class="form-control" placeholder="Enter Affilation Number">
                        </div>
                        <div class="form-group">
                            <label >Board</label>
                            <input type="text" name="board" class="form-control" placeholder="Enter Affilation Board">
                        </div>
