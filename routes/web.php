...
Route::middleware('auth', 'OnlySchool')->group(function(){
	// Teacher Routes
		...
		Route::get('teacher/delete/{id}', 'School\TeacherController@delete')->name('teacher.delete');
		Route::post('/UpdateTeacherStatus', 'School\TeacherController@TeacherStatus')->name('teacher.status');
